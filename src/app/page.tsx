...
export default async function Home() {
  ...
  return (
    <main className='min-h-screen relative font-inter'>
      ...
      <div className="container mx-auto flex lg:justify-center py-12 px-4">
        <div className="bg-black text-3xl md:text-5xl lg:text-6xl uppercase font-black text-white p-2"><span className="text-red-500">C</span>haracter</div>
      </div>
